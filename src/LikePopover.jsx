  ...
  return (
    ...
    >
      ...
      {show && likers.length > 0 && (
        <div className="absolute z-50 bottom-full mb-2 left-1/2 -translate-x-1/2 bg-white border border-gray-300 rounded shadow-lg p-2 text-xs text-gray-800 w-max max-w-xs">
